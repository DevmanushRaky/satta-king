      ...
      <div className="container m-5">
        ...
        <Accordion defaultActiveKey="0" flush>
          ...
          <Accordion.Item eventKey="0">
            <Accordion.Header>What is satta king ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header> How much profit can I make playing Satta king ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header> What is Satta Matka King ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="3">
            <Accordion.Header> What is the difference between Satta Matka and Satta King ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="4">
            <Accordion.Header> Where should I play Satta King ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="5">
            <Accordion.Header>Who are khaiwals ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="6">
            <Accordion.Header> Is it legal to play Satta King ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="7">
            <Accordion.Header> Can I get rich playing Satta King ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="8">
            <Accordion.Header> What are Jodi and Dhara ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="9">
            <Accordion.Header>What are some types of Satta king ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="10">
            <Accordion.Header> What are the basic requirements to play Satta king ? </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="11">
            <Accordion.Header>Where should I find a khaiwal ? </Accordion.Header>
            <Accordion.Body>
